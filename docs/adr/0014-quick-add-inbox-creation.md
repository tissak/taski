...
- **Status:** Accepted (the "reorder … remain rejected" clause in this ADR's gate boundary was **revoked 2026-06-24 by [ADR-0020](./0020-task-reordering.md)**, and the "line deletion remain rejected" clause was **revoked 2026-06-24 by [ADR-0021](./0021-archive-completed-tasks.md)** — bounded to its copy-then-delete archival operation, whose **Phase A reuses this ADR's append-only creation gate and first-creation path unchanged**; this ADR's append-only creation gate is otherwise unchanged)
- **Date:** 2026-06-21
